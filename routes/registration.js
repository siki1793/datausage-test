...
registration.post(function(req,res){

	// decrypting the message received	
	try {
		console.log("req handler regis was called.");
		...
		getlogs.find({"mobileNumber":received.mobileNumber},function(err,docs){
			if(err){
				console.log(err);
			}
			else{
